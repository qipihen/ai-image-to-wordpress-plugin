...
- Batch generation (1-6 variations in one run)
...
3. Optional: set batch count (1-6).
4. Choose usage profile: `content`, `featured`, or `hero`.
5. Click **Generate and Upload**.
6. Copy generated image URL(s) and use in posts/pages.
